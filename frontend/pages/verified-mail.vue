...
<template>
  <section class="background-image pb-20">
    <Navbar />
    ...
    <div class="flex items-center justify-center flex-col gap-12 mt-10 px-4" v-else>
      ...
      <div class="text-white text-center flex flex-col gap-5">
        ...
        Welcome in the waitlist of Arises
        </h1>

        <p class="inter">We will send you an email when the app is ready</p>

        <p class="inter">But you can already try the chrome extension : </p>
      </div>

      <VideoShowcase />

      <a target="_blank" href="https://chromewebstore.google.com/detail/arises-pomodoro-timer-dis/aheohjodpllofjdihniljfkppcacpeib" class="w-full xl:w-1/3 w-1/2 inter">
