...
<template>
  <div class="flex items-center justify-center flex-col gap-12 mt-10 px-4">
    ...
    <a href="https://chrome.google.com/webstore" class="w-full xl:w-1/3 w-1/2">
      <UButton type="submit" class="bg-[#445EF2] hover:bg-[#445EF2] hover:bg-opacity-70 cta w-full inter">
